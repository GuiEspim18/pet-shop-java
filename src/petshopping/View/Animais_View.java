 ...
 * @author guiespim
 */
public class Animais_View extends javax.swing.JFrame {

    /**
     * Creates new form Animais_View
     */
    public Animais_View() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animais_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animais_View().setVisible(true);
            }
        });
    }
